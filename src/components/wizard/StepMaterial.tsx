...
const materials: { id: MaterialChoice; label: string; subtitle: string; img: string; cornerImg?: string; features: string[]; icon: React.ReactNode; metalIdx?: number }[] = [
  ...
  },
  {
    ...
    features: ["Ultra-thin .040\" aluminum", "Double-sided option available", "Scratch & fade resistant", "Lightweight — easy to hang"],
  ...
  },
  {
    ...
    features: ["Heavy-gauge .080\" aluminum", "Double-sided option available", "Superior color depth", "Rigid & substantial feel"],
